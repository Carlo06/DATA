...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    private javafx.scene.control.Button log_loginBtn,reg_signupBtn,log_loginBtnMob;

    @FXML
    private PasswordField log_password,reg_password,reg_confirm_password;
        ...
        try{
            ...
            if(log_username.getText().isEmpty()|| log_password.getText().isEmpty() ){
                ...
                if(result.next() ){
                    ...
                    Parent root = FXMLLoader.load(getClass().getResource("/view/taskController.fxml"));
        ...
        try{
            ...
            if(log_username.getText().isEmpty()|| log_password.getText().isEmpty() ){
                ...
                if(result.next()){
                    ...
                    log_loginBtnMob.getScene().getWindow().hide();
                    
                    Parent root = FXMLLoader.load(getClass().getResource("/view/mobileSize.fxml"));
    ...
    public void registerAccount(){
        ...
        try{
            ...
            if(reg_username.getText().isEmpty() ||reg_password.getText().isEmpty() || reg_email.getText().isEmpty() || reg_confirm_password.getText().isEmpty() ){
                alert = new Alert(AlertType.ERROR);
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
    ...
    public void SwitchSize(ActionEvent event) throws IOException {
       

        Stage newStage = new Stage();
        newStage.setTitle("Task Manager System");
        Parent root = null;

        if (event.getSource() == switchToWeb) {
            alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Information Message");
                alert.setHeaderText(null);
                alert.setContentText("Successfully changed to Web Size");
                alert.showAndWait();
                    
                switchToWeb.getScene().getWindow().hide();
                ...
                if (event.getSource() == SwitchToMobile){ 
                alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Information Message");
                alert.setHeaderText(null);
                alert.setContentText("Successfully changed to Mobile Size");
                alert.showAndWait();
                    
                SwitchToMobile.getScene().getWindow().hide();
                    
                root = FXMLLoader.load(getClass().getResource("/view/FXMLDocumentMobileSize.fxml"));
        ...
        if (root != null) {
            ...
            currentStage = newStage; // Update the current stage reference to the new stage
        }
    }
